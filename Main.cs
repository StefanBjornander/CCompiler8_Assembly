...
namespace CCompiler {
  public class Start {
    ...
    public static StreamWriter symbolStream = new StreamWriter(@"C:\Users\stefa\Documents\A A C_Compiler_CSharp_8_AssemblyX\C_Compiler_CSharp_8_Assembly\\Test2.txt");
    ...
    public static void Main(string[] args) {
      ...
      string pathName = @"C:\Users\stefa\Documents\vagrant\homestead\code\code\";
      ...
      try {
        ...
        if (!noLink && doLink) {
          ...
          string pathName3 = @"C:\Users\stefa\Documents\A A C_Compiler_CSharp_8_Assembly\C_Compiler_CSharp_8_Assembly\";
          FileInfo asmFile = new FileInfo(pathName3 + argList[0] + "_Asm.asm");
